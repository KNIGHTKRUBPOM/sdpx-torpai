...
> “UniLib แก้ปัญหาที่นักศึกษาไม่รู้ว่าหนังสือว่างหรือไม่ และต้องพึ่งเจ้าหน้าที่ในการยืมคืนทุกครั้ง ระบบนี้ทำให้สมัคร ค้นหา ยืม คืน และติดตามกำหนดคืนได้จากบัญชีเดียว ขณะที่บรรณารักษ์เพิ่มหนังสือและจัดการรายการยืมได้”
...
1. เปิดหน้าเพิ่มหนังสือและกรอก ISBN-10 หรือ ISBN-13
2. แสดงว่าระบบตัดช่องว่าง/ขีด และปฏิเสธ ISBN ซ้ำ
3. เปิดรายการยืมทั้งหมดและสาธิตรับคืนแทนนักศึกษา

> “Role ถูกตรวจทั้ง route ฝั่ง frontend และ authorization ฝั่ง backend นักศึกษาจึงเปิดหน้า admin หรือเรียก API เพิ่มหนังสือไม่ได้”
...
- Backend 22 tests และ coverage 91%
