...
- [x] ผู้ใช้สามารถค้นหาหนังสือ กรองตามหมวดหมู่ และเช็คสถานะการยืม (Available/Borrowed) ได้แบบเรียลไทม์
- [x] ผู้ใช้สามารถทำรายการยืมและคืนหนังสือผ่านบัญชีที่ Login และ ISBN ได้สำเร็จ
- [x] บรรณารักษ์สามารถเพิ่มและลบหนังสือที่ไม่มี active loan โดยไม่ทำลายประวัติการยืม
